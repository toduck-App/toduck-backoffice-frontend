...
import { Calendar, Clock, Send, AlertCircle, CalendarIcon, ChevronLeft, ChevronRight } from 'lucide-react'
...
export function NotificationForm({ isOpen, onClose, onSubmit }: NotificationFormProps) {
        ...
        <div className="flex-shrink-0 p-8 pb-4">
          <DialogHeader className="mb-6">
            ...
            <DialogDescription className="mt-2">
              전체 사용자에게 발송할 알림을 작성합니다. 신중하게 작성해주세요.
            </DialogDescription>
          </DialogHeader>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-8 min-h-0">
          ...
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            <p className="text-sm text-red-700 flex items-center gap-2">
              ...
              <span>
                이 알림은 <strong>모든 활성 사용자</strong>에게 발송됩니다. 발송 후에는
